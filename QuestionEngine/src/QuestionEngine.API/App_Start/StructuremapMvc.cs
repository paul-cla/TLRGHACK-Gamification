...
namespace Keywords.API.App_Start {
    public static class StructuremapMvc {
        public static void Start() {
            ...
            GlobalConfiguration.Configuration.Filters.Add(new GeneralExceptionFilterAttribute(ErrorMapper.Map));
            ExceptionObservers.Add(ObjectFactory.GetInstance<ErrorObserver>());
        }
    }
}